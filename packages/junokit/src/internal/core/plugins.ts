...
export function usePlugin (
  ...
  if (JunokitContext.loadedPlugins.includes(pluginName)) {
    return;
  }
  ...
  JunokitContext.setPluginAsLoaded(pluginName);
}
